$(window).load(function(){
	...
	$('#services .tabs').navs({
		...
		$('#services .tabs-items').tabs(n)
	})
	
	$('#services .tabs-items').tabs(1)
	
	$('#form1').forms()
	
	var bg=['/includes/special/images/bg1.jpg','/includes/special/images/bg2.jpg','/includes/special/images/bg3.jpg','/includes/special/images/bg4.jpg'],
		bgDuration=6000,
		bgInt,
		bgPags=
	$('.bg-pags')
